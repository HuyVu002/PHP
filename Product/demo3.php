...
<body>
  <div class="container">
    <form action="/Product/demo3.php" method="GET">
        <div class="row">
          <div class="col">
  ...
  <div class="container">
    <a href="/Product/createform.php">Create a new product</a>
    <table class="table">
  <thead>
    <tr>
      <th scope="col">#</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="/Product/edit.php?id=<?php echo $item["id"]; ?>">Edit</a></td>
      <td><a onclick="return confirm('Are you sure delete product?')" 
          class="text-danger" href="/Product/delete.php?id=<?php echo $item["id"]; ?>">
          Delete</a></td>
    </tr>
    <?php endforeach;?>
  </tbody>
